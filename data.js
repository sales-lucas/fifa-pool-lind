...
const BRACKET_MATCHES = [
  { id: "r32-1",  round: "r32", label: "2nd A vs 2nd B", home: slotGroup(2, "A"), away: slotGroup(2, "B"), advance: { match: "r16-1", slot: "home" } },
  { id: "r32-2",  round: "r32", label: "1st E vs 3rd", home: slotGroup(1, "E"), away: slotThird("E", ["A", "B", "C", "D", "F"]), advance: { match: "r16-1", slot: "away" } },
  { id: "r32-3",  round: "r32", label: "1st F vs 2nd C", home: slotGroup(1, "F"), away: slotGroup(2, "C"), advance: { match: "r16-2", slot: "home" } },
  { id: "r32-4",  round: "r32", label: "1st C vs 2nd F", home: slotGroup(1, "C"), away: slotGroup(2, "F"), advance: { match: "r16-2", slot: "away" } },
  { id: "r32-5",  round: "r32", label: "1st I vs 3rd", home: slotGroup(1, "I"), away: slotThird("I", ["C", "D", "F", "G", "H"]), advance: { match: "r16-3", slot: "home" } },
  ...
  { id: "r32-9",  round: "r32", label: "1st D vs 3rd", home: slotGroup(1, "D"), away: slotThird("D", ["B", "E", "F", "I", "J"]), advance: { match: "r16-5", slot: "home" } },
  { id: "r32-10", round: "r32", label: "1st G vs 3rd", home: slotGroup(1, "G"), away: slotThird("G", ["A", "E", "H", "I", "J"]), advance: { match: "r16-5", slot: "away" } },
  { id: "r32-11", round: "r32", label: "2nd K vs 2nd L", home: slotGroup(2, "K"), away: slotGroup(2, "L"), advance: { match: "r16-6", slot: "home" } },
  { id: "r32-12", round: "r32", label: "1st H vs 2nd J", home: slotGroup(1, "H"), away: slotGroup(2, "J"), advance: { match: "r16-6", slot: "away" } },
  { id: "r32-13", round: "r32", label: "1st B vs 3rd", home: slotGroup(1, "B"), away: slotThird("B", ["E", "F", "G", "I", "J"]), advance: { match: "r16-7", slot: "home" } },
  { id: "r32-14", round: "r32", label: "1st J vs 2nd H", home: slotGroup(1, "J"), away: slotGroup(2, "H"), advance: { match: "r16-7", slot: "away" } },
  { id: "r32-15", round: "r32", label: "1st K vs 3rd", home: slotGroup(1, "K"), away: slotThird("K", ["D", "E", "I", "J", "L"]), advance: { match: "r16-8", slot: "home" } },
  { id: "r32-16", round: "r32", label: "2nd D vs 2nd G", home: slotGroup(2, "D"), away: slotGroup(2, "G"), advance: { match: "r16-8", slot: "away" } },
